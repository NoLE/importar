...
<div class="container-fluid">
    <center><h2><u>Importador de Docentes</u></h2></center>
    <br>
    <div class="row">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div id="imgImport">
                            <br>
                            <center>
                                <img src="datos.jpg" alt="" width="70%" style="display: none;" >
                            </center>
                        </div>
                        <br>
...
<script>
    $('#btn_lectura').click(function () {
        ...
        $('#my_file_output tr').each(function () {
            ...
            console.log (valor);
           // alert(valor);
            $.post('insertar.php', {d1:d1, d2:d2, d3:d3, d4:d4, d5:d5, d6:d6, d7:d7, d8:d8, d9:d9, d10:d10}, function (datos) {
